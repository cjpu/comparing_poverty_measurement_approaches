...
# Purpose: Visualize accordance between "bottom 10" (i.e., households with the lowest 10 PPI scores) and "top 10" (i.e., households with the highest 10 PPI scores) households based on their PPI scores, DHS scores, regular expenditures per capita, Krishna's Stages of Progress in rural Ethiopia
...
# Sample sizes: Rural Dera (n = 2,475)
...
# comparing top 10 and bottom 10 ppi households in rural dera ------------------------------------------------------------------
...
ethiopia_listing_cleaned %>% 
  ...
  filter(
    ppi_rank_rounded <= b10_ppi_rural_dera
  ) %>% 
