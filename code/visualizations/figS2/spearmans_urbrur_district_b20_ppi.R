...
# Purpose: Visualize Spearman rank correlation coefficients among b20 households (based on their PPI scores) between the PPI, DHS, and Regular expenditures for urban and rural strata at the district-level in Ethiopia, Ghana, and Uganda with bootstrapped confidence intervals
...
# Outputs: Panel C in Supplementary Figure 2
# Sample sizes: rural Dera (n = 816), rural Farta (n = 511), rural North Mecha (n = 680), rural Asutifi North (n = 276), rural Wassa East (n = 384), rural Kabarole (n = 282), rural Lira (n = 317), urban Dera (n = 133), urban Farta (n = 62), urban North Mecha (n = 98), urban Asutifi North (n = 134), urban Wassa East (n = 48), urban Kabarole (n = 142), urban Lira (n = 102)
...
spearmans_urbrur_district_b20_ppi <- tribble(
...
spearmans_urbrur_district_b20_ppi_graph <- ggplot(
  data = spearmans_urbrur_district_b20_ppi, 
  aes(
    x = as.factor(sample),
    color = country,
    shape = stratum
