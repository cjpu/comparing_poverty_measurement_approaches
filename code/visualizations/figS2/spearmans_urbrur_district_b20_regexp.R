...
# Purpose: Visualize Spearman rank correlation coefficients among b20 households (based on their regular expenditures) between the PPI, DHS, and Regular expenditures for urban and rural strata at the district-level in Ethiopia, Ghana, and Uganda with bootstrapped confidence intervals
...
# Outputs: Panel D in Supplementary Figure 2
# Sample sizes: rural Dera (n = 501), rural Farta (n = 497), rural North Mecha (n = 504), rural Asutifi North (n = 241), rural Wassa East (n = 403), rural Kabarole (n = 335), rural Lira (n = 285), urban Dera (n = 92), urban Farta (n = 58), urban North Mecha (n = 84), urban Asutifi North (n = 147), urban Wassa East (n = 57), urban Kabarole (n = 110), urban Lira (n = 72)
...
spearmans_urbrur_district_b20_regexp <- tribble(
...
spearmans_urbrur_district_b20_regexp_graph <- ggplot(
  data = spearmans_urbrur_district_b20_regexp, 
  aes(
    x = as.factor(sample),
    color = country,
    shape = stratum
  ...
  labs(col="Country", shape="Stratum")+
