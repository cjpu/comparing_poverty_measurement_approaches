...
# Purpose: Visualize accordance between "bottom 10" (i.e., households with the lowest 10 DHS scores) and "top 10" (i.e., households with the highest 10 DHS scores) households based on their PPI scores, DHS scores, regular expenditures per capita, Krishna's Stages of Progress in rural Uganda
...
# comparing top 10 and bottom 10 dhs households in rural lira ------------------------------------------------------------------
...
uganda_listing_cleaned %>% 
  ...
  filter(
    dhs_rank_rounded <= b10_dhs_rural_lira
  ) %>% 
...
# comparing top 10 and bottom 10 dhs households in rural kabarole ------------------------------------------------------------------
...
uganda_listing_cleaned %>% 
  ...
  filter(
    dhs_rank_rounded <= b10_dhs_rural_kabarole
  ) %>% 
