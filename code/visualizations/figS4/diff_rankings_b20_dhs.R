...
# Purpose: Compare the distributions of the differences in percentile rankings among b20 households (defined by the DHS) based on households' PPI scores, DHS scores, and regular expenditures per capita in Ethiopiga, Ghana, and Uganda
...
# Outputs: Panel A of Supplementary Figure 4
# Sample sizes: Rural b20 DHS households [Dera (n = 496), Farta (n = 494), North Mecha (n = 505), Asutifi North (n = 229), Wassa East (n = 384), Kabarole (n = 271), and Lira (n = 271)]
# Sample sizes: Urban b20 DHS households [Dera (n = 92), Farta (n = 58), North Mecha (n = 83), Asutifi North (n = 131), Wassa East (n = 44), Kabarole (n = 104), and Lira (n = 72)]
...
# boxplot of differences in percentile rankings for b20 households based on their DHS scores -------------------

boxplot_percent_rankings_diff_b20_dhs <- ggboxplot(
  ...
  bind_rows(
    ethiopia_listing_cleaned %>% 
      ...
      # isolate B20 households based on DHS scores
...
# sample sizes for b20 DHS analysis -------------------------------------------
...
# computing mean percentile difference in rankings = 26.07 (i.e., an entire quartile) across all urb/rur districts for b20 dhs households ------------------------------------------
...
# computing minimum median percentile difference in rankings = 7.87 across all urb/rur districts for b20 dhs households ------------------------------------------
...
# computing minimum median percentile difference in rankings = 33.28 across all urb/rur districts for b20 dhs households ------------------------------------------
