...
# Purpose: Visualize accordance between "bottom 10" (i.e., households with the lowest 10 DHS scores) and "top 10" (i.e., households with the highest 10 DHS scores) households based on their PPI scores, DHS scores, regular expenditures per capita, Krishna's Stages of Progress in urban Ethiopia
# Inputs: Cleaned dataset (ethiopia_listing_selected_vars_cleaned.rds) produced by clean_ethiopia.R
# Outputs: Figure 2
# Sample sizes: Urban Dera (n = 461), Urban Farta (n = 288), Urban North Mecha (n = 414)
...
# defining top 10 and bottom 10 ranks for urban dera households only  ----------------------------------------------

t10_dhs_urban_dera = 452
b10_dhs_urban_dera = 10
t10_ppi_urban_dera = 453
b10_ppi_urban_dera = 10
t10_regexppcpd_urban_dera = 452
b10_regexppcpd_urban_dera = 10

# defining top 10 and bottom 10 ranks for urban farta households only ----------------------------------------------

t10_dhs_urban_farta = 279
b10_dhs_urban_farta = 10
t10_ppi_urban_farta = 262
b10_ppi_urban_farta = 10
t10_regexppcpd_urban_farta = 279
b10_regexppcpd_urban_farta = 12

# defining top 10 and bottom 10 ranks for urban north mecha households only ----------------------------------------------

t10_dhs_urban_northmecha = 405
b10_dhs_urban_northmecha = 10
t10_ppi_urban_northmecha = 405
b10_ppi_urban_northmecha = 10
t10_regexppcpd_urban_northmecha = 405
b10_regexppcpd_urban_northmecha = 10

# comparing top 10 and bottom 10 dhs households in urban dera ------------------------------------------------------------------
...
ethiopia_listing_cleaned %>% 
  ...
  filter(
    dhs_rank_rounded <= b10_dhs_urban_dera
  ) %>% 
    ...
    list(
      filler1 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler1 <= b10_dhs_urban_dera, "red",
                                                  ifelse(filler1 >= t10_dhs_urban_dera, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
      filler2 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler2 <= b10_ppi_urban_dera, "red",
                                                  ifelse(filler2 >= t10_ppi_urban_dera, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
      filler3 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler3 <= b10_regexppcpd_urban_dera, "red",
                                                  ifelse(filler3 >= t10_regexppcpd_urban_dera, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
...
# comparing top 10 and bottom 10 dhs households in urban farta ------------------------------------------------------------------
...
ethiopia_listing_cleaned %>% 
  ...
  filter(
    dhs_rank_rounded <= b10_dhs_urban_farta
  ) %>% 
    ...
    list(
      filler1 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler1 <= b10_dhs_urban_farta, "red",
                                                  ifelse(filler1 >= t10_dhs_urban_farta, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
      filler2 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler2 <= b10_ppi_urban_farta, "red",
                                                  ifelse(filler2 >= t10_ppi_urban_farta, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
      filler3 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler3 <= b10_regexppcpd_urban_farta, "red",
                                                  ifelse(filler3 >= t10_regexppcpd_urban_farta, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
...
# comparing top 10 and bottom 10 dhs households in urban north mecha ------------------------------------------------------------------
...
ethiopia_listing_cleaned %>% 
  ...
  filter(
    dhs_rank_rounded <= b10_dhs_urban_northmecha
  ) %>% 
    ...
    list(
      filler1 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler1 <= b10_dhs_urban_northmecha, "red",
                                                  ifelse(filler1 >= t10_dhs_urban_northmecha, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
      filler2 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler2 <= b10_ppi_urban_northmecha, "red",
                                                  ifelse(filler2 >= t10_ppi_urban_northmecha, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
      filler3 = formatter("span",
                          style = ~style(display = "block",
                                         ...
                                         "padding-right" = "4px",
                                         "background-color" = 
                                           ifelse(filler3 <= b10_regexppcpd_urban_northmecha, "red",
                                                  ifelse(filler3 >= t10_regexppcpd_urban_northmecha, "green", "lightgrey"
                                                  )
                                           )
                          )
      ),
