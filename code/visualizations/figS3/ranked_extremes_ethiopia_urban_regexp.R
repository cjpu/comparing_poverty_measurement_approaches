...
# Sample sizes: Urban Dera (n = 461), Urban North Mecha (n = 414)
...
# comparing top 10 and bottom 10 regexp households in urban dera ------------------------------------------------------------------
...
ethiopia_listing_cleaned %>% 
  ...
  filter(
    regexppcpd_rank_rounded <= b10_regexppcpd_urban_dera
  ) %>% 
...
# comparing top 10 and bottom 10 regexp households in urban north mecha ------------------------------------------------------------------
...
ethiopia_listing_cleaned %>% 
  ...
  filter(
    regexppcpd_rank_rounded <= b10_regexppcpd_urban_northmecha
  ) %>% 
