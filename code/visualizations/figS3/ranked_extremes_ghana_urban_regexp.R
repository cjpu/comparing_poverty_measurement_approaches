...
# comparing top 10 and bottom 10 regexp households in urban asutifi north ------------------------------------------------------------------
...
ghana_listing_cleaned %>% 
  ...
  filter(
    regexppcpd_rank_rounded <= b10_regexppcpd_urban_asutifinorth
  ) %>% 
