...
# Purpose: Compare the distributions of the differences in percentile rankings among b20 households (defined by the PPI) based on households' PPI scores, DHS scores, and regular expenditures per capita in Ethiopiga, Ghana, and Uganda
...
# Outputs: Panel B of Supplementary Figure 4
# Sample sizes: Rural b20 PPI households [Dera (n = 816), Farta (n = 511), North Mecha (n = 680), Asutifi North (n = 276), Wassa East (n = 384), Kabarole (n = 282), and Lira (n = 317)]
# Sample sizes: Urban b20 PPI households [Dera (n = 133), Farta (n = 62), North Mecha (n = 98), Asutifi North (n = 134), Wassa East (n = 48), Kabarole (n = 142), and Lira (n = 102)]
...
# boxplot of differences in percentile rankings for b20 households based on their PPI scores -------------------

boxplot_percent_rankings_diff_b20_ppi <- ggboxplot(
  ...
  bind_rows(
    ethiopia_listing_cleaned %>% 
      ...
      # isolate B20 households based on PPI scores
...
# sample sizes for b20 PPI analysis -------------------------------------------
...
# computing mean percentile difference in rankings = 26.40 (i.e., an entire quartile) across all urb/rur districts for b20 ppi households ------------------------------------------
...
# computing minimum median percentile difference in rankings = 12.27 across all urb/rur districts for b20 ppi households ------------------------------------------
...
# computing minimum median percentile difference in rankings = 39.04 across all urb/rur districts for b20 ppi households ------------------------------------------
