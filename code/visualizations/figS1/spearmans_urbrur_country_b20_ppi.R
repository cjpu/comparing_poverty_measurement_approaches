...
# Purpose: Visualize Spearman rank correlation coefficients between the PPI, DHS, and Regular expenditures for urban and rural strata among b20 households (according to their PPI scores) at the country-level in Ethiopia, Ghana, and Uganda with bootstrapped confidence intervals
...
# Outputs: Panel B in Supplementary Figure 1
# Sample sizes: All rural (n = 2,816), All urban (n = 587), Rural Ethiopia (n = 1,812), Urban Ethiopia (n = 250), Rural Ghana (n = 648), Urban Ghana (n = 197), Rural Uganda (n = 599), Urban Uganda (n = 202)
...
spearmans_urbrur_country_b20_ppi <- tribble(
...
spearmans_urbrur_country_b20_ppi_graph <- ggplot(
  data = spearmans_urbrur_country_b20_ppi, 
  aes(
    x = as.factor(sample),
    color = country,
    shape = stratum
