...
# Purpose: Visualize Spearman rank correlation coefficients between the PPI, DHS, and Regular expenditures for urban and rural strata among b20 households (according to their regular expenditures) at the country-level in Ethiopia, Ghana, and Uganda with bootstrapped confidence intervals
...
# Outputs: Panel D in Supplementary Figure 1
# Sample sizes: All rural (n = 2,728), All urban (n = 592), Rural Ethiopia (n = 1,494), Urban Ethiopia (n = 233), Rural Ghana (n = 623), Urban Ghana (n = 175), Rural Uganda (n = 570), Urban Uganda (n = 176)
...
spearmans_urbrur_country_b20_regexp <- tribble(
...
spearmans_urbrur_country_b20_regexp_graph <- ggplot(
  data = spearmans_urbrur_country_b20_regexp, 
  aes(
    x = as.factor(sample),
    color = country,
    shape = stratum
