...
# Purpose: Visualize Spearman rank correlation coefficients among b20 households (based on their DHS scores) between the PPI, DHS, and Regular expenditures for urban and rural strata at the district-level in Ethiopia, Ghana, and Uganda with bootstrapped confidence intervals
...
# Outputs: Panel B in Supplementary Figure 2
# Sample sizes: rural Dera (n = 496), rural Farta (n = 494), rural North Mecha (n = 505), rural Asutifi North (n = 229), rural Wassa East (n = 384), rural Kabarole (n = 271), rural Lira (n = 271), urban Dera (n = 92), urban Farta (n = 58), urban North Mecha (n = 83), urban Asutifi North (n = 131), urban Wassa East (n = 44), urban Kabarole (n = 104), urban Lira (n = 72)
...
spearmans_urbrur_district_b20_dhs <- tribble(
...
spearmans_urbrur_district_b20_dhs_graph <- ggplot(
  data = spearmans_urbrur_district_b20_dhs, 
  aes(
    x = as.factor(sample),
    color = country,
    shape = stratum
